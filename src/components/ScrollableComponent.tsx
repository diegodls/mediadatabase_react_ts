            ...
            {isScrollable ? (
              <>
                <button
                  ...
                  className={`w-[${BUTTON_WIDTH}px] h-list-md flex items-center justify-center scale-y-90 bg-black/20 hover:bg-black/80 rounded-r-sm overflow-hidden absolute left-0 z-50 cursor-pointer transition-all select-none ${
                ...
                <button
                  ...
                  className={`w-[${BUTTON_WIDTH}px] h-list-md flex items-center justify-center scale-y-90 bg-black/50 hover:bg-black/80 rounded-l-sm overflow-hidden absolute right-0 z-50 cursor-pointer transition-all select-none  ${
                    isMouseOverList ? "opacity-100" : "opacity-0"
                  }`}
                >
