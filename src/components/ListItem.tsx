  ...
  return (
    ...
    >
      <NavLink
        ...
        className='group h-full rounded-md cursor-pointer relative overflow-hidden transform transition-all scale-90 hover:scale-100 hover:drop-shadow-xl hover:z-10 focus-visible:scale-100 focus-visible:drop-shadow-xl focus-visible:z-50  focus-visible:outline-none focus-visible:ring-0 focus-visible:border-2 focus-visible:border-customColors-red-500'
      >
